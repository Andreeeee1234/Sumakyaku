...
with app.app_context():
    ...
    db.create_all()
    HistorialRuta = models_dict["HistorialRuta"]
    Procesamiento = models_dict["Procesamiento"]
    Embalse = models_dict["Embalse"]
    PuntoCritico = models_dict["PuntoCritico"]
    Nodo = models_dict["Nodo"]
    Arista = models_dict["Arista"]
